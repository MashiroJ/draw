...
public class SuperDrawDto {
    @Schema(description = "绘画提示词", example = "1 girl, Loli, cute, solo, beautiful and delicate eyes, exquisite face, sweater, pink hair, side bun, violet eyes, high gloss dyeing, shirt, micro skirt, black pantyhose, perspective, street, bell tower, depth of field, gray background coloring.")
